...
fn test_toplevel_tuple_struct() {
    insta::assert_ron_snapshot!(
        run_yaml_modes_on_prefixes_and_format_outputs::<Tuple>(&default_modes(), &"[[true], [false], [true]]"),
        @r###"
    {
      "default behavior": {
...
fn test_tuple_struct() {
    insta::assert_ron_snapshot!(
        run_yaml_modes_on_prefixes_and_format_outputs::<Vec<Tuple>>(&default_modes(), &"[[[true], [false], [true]], [[false], [true], [false]]]"),
        @r###"
    {
      "default behavior": {
        "": Ok([]),
...
fn test_toplevel_tuple_struct_with_default() {
    insta::assert_ron_snapshot!(
        run_yaml_modes_on_prefixes_and_format_outputs::<TupleWithDefault>(&default_modes(), &"[[true], [false], [true]]"),
        @r###"
    {
      "default behavior": {
        "": Err("could not find a potential backtrack point (do you have #[serde(default)] on your top-level type? are your settings too strict?) (after 0 backtracks)"),
...
fn test_tuple_struct_with_default() {
    insta::assert_ron_snapshot!(
        run_yaml_modes_on_prefixes_and_format_outputs::<Vec<TupleWithDefault>>(&default_modes(), &"[[[true], [false], [true]], [[false], [true], [false]]]"),
        @r###"
    {
      "default behavior": {
        "": Ok([]),
