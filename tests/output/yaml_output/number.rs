...
fn test_i32() {
    insta::assert_ron_snapshot!(
        run_yaml_modes_on_prefixes_and_format_outputs::<Vec<i32>>(&default_modes(), &"[0, 1, 12345, -54321]"),
        @r###"
    {
      "default behavior": {
        "": Ok([]),
...
fn test_i32_overflow() {
    insta::assert_ron_snapshot!(
        run_yaml_modes_on_prefixes_and_format_outputs::<Vec<i32>>(&default_modes(), &"[0, 1, 1234567890]"),
    @r###"
    {
      "default behavior": {
        "": Ok([]),
...
fn test_f32() {
    insta::assert_ron_snapshot!(
        run_yaml_modes_on_prefixes_and_format_outputs::<Vec<f32>>(
            &default_modes(),
